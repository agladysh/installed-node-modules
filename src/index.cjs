 ...
 *
 * @param {boolean} [withWorkspace=true] - Whether to include workspace packages in the result
 * @returns {string[]} Array of module names that can be used with require() or import
 *
 * @example
